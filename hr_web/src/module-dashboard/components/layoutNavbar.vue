<template>
  <el-menu class="navbar" mode="horizontal">
    ...
    <div class="right-menu">
      ...
      <!-- Readme -->
      <a href="https://github.com/AsheOne18/HR-Management" class="item" target="_blank">
        <el-tooltip class="item" effect="dark" content="readme" placement="bottom"><i class="el-icon-question"></i></el-tooltip>
      </a>
      <!-- Error -->
      ...
      <el-dropdown class="item">
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <a target='_blank' href="https://github.com/AsheOne18/HR-Management">
            <el-dropdown-item>
              {{$t('navbar.github')}}
            </el-dropdown-item>
          </a>
...
.navbar {
  ...
  background-image: -webkit-linear-gradient(left, #60559e, #ec9de2);
  .hamburger-container {
    line-height: 58px;
    height: 50px;
    float: left;
